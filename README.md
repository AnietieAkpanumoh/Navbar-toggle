...
A Navbar toggle project using HTML, CSS, and a little bit of JavaScript. 
...
```bash
git clone git@github.com:anietieakpanumoh/Navbar-toggle.git
```
...
Feel free to check the [issues page](https://github.com/AnietieAkpanumoh/Navbar-toggle/issues).
